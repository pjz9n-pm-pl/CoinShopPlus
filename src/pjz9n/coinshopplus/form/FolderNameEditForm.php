...
class FolderNameEditForm extends AbstractCustomForm
{
    /** @var Folder */
    private $folder;
    ...
    public function __construct(Folder $folder)
    {
        ...
        parent::__construct(
            ...
            [
                new Input("name", Language::get()->translateString("folder.name"), "", $folder->getName()),
            ]
        );
    }
    ...
    {
        $oldName = $this->folder->getName();
        $this->folder->setName($response->getString("name"));
